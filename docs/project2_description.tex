...
% --- begin date ---
\begin{center}
Spring semester 2026, deadline June 1
\end{center}
% --- end date ---
...
\addcontentsline{toc}{section}{Possible paths for project 2}
...
\addcontentsline{toc}{subsection}{Alternative one, QFTs}
...
\addcontentsline{toc}{subsection}{Alternative two, Quantum Machine Learning}
...
\addcontentsline{toc}{subsection}{Alternative three, Quantum Boltzmann Machines}
...
\addcontentsline{toc}{subsection}{Alternative four, Adaptive VQE}
...
\addcontentsline{toc}{subsection}{Introduction to numerical projects}
...
\addcontentsline{toc}{subsection}{Format for electronic delivery of report and programs}
