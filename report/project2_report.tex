...
\section*{Declaration of limited AI assistance}
I used ChatGPT in a limited supporting role during this project. The implementation, numerical experiments, figures, tables, and final scientific interpretation are my own responsibility. The AI assistance was mainly used for repository organization, terminal and Git guidance, plotting/report formatting, and proofreading. I reviewed and edited the suggestions before including them in the final repository and report. All reported values come from the project code and generated result files.
...
\bibitem{grading}
Computational Physics, ``Evaluation and grading of projects,'' University of Oslo. \url{https://github.com/CompPhysics/QuantumComputingMachineLearning/tree/gh-pages/doc/Projects/EvaluationGrading}

\bibitem{examples}
Computational Physics, ``Project examples and report-writing resources,'' University of Oslo. \url{https://github.com/CompPhysics/QuantumComputingMachineLearning/tree/gh-pages/doc/Projects/ProjectExamples}
\end{thebibliography}
